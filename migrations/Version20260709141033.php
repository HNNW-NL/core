 ...
 */
final class Version20260709141033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_project_work_package_scope ON work_packages (project_id, slug)');
